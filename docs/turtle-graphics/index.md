...
This recipe shows how to run a Python turtle graphics program in the browser with PyScript by drawing into SVG.

!!! info
    This recipe targets PyScript `2026.3.1`.
...
=== "index.html"
    ...
    <head>
      ...
      <title>PyScript Turtle Graphics</title>
      <script type="module" src="https://pyscript.net/releases/2026.3.1/core.js"></script>
      <script type="mpy" src="./main.py" config="./pyscript.toml"></script>
    </head>
    <body>
      <h1>PyScript Turtle Graphics</h1>
      <div id="turtle-output"></div>
    </body>
    </html>
    ```
...
- Call `done()` after drawing.
- If you omit `target=...`, the drawing is appended to the default page wrapper.

## Full source code: `svg.py`
